...
var Common = {	
	...
	getTime : function(){
		var me = this;
		var url = '/api/anon/v1/lottery/times';
		clearInterval(me.t);
	...
	getIssue : function(lt,el){
		var me = this;
		var url = '/api/anon/v1/lottery/issue_info?lottery=' + lt + '&_=' + new Date().getTime();
		me.getAjax(url,function(res){
	...
	getHistory : function(lt){
		...
		var me = this;
		var url = '/api/u/v1/lottery/trend?lottery=' + lt+ '&startTime=' + date + '&endTime=' + date + '&issuecount=20&_=' + new Date().getTime();
