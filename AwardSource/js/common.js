...
//		$.ajax({
//			url: '/api/anon/v1/lottery/issue_info?lottery=' + lt + '&_=' + new Date().getTime(),
//			type: 'GET',
//			dataType: 'json',
//		}).done(function(res){
...
//		});
	...
	getHistory : function(lt,date){
		var date = $('#datepick').val();
//		$.ajax({
//			url: '/api/u/v1/lottery/trend?lottery=' + lt+ '&startTime=' + date + '&endTime=' + date + '&issuecount=20&_=' + new Date().getTime(),
//			type: 'GET',
//			dataType: 'json',
//		}).done(function(res){
